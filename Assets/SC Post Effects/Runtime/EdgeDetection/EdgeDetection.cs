...
namespace SCPE
{
    ...
    public sealed class EdgeDetection : PostProcessEffectSettings
    {
        ...
        [DisplayName("Depth sensitivity"), Range(0f, 1f), Tooltip("Sets how much difference in depth between pixels contribute to drawing an edge")]
        public FloatParameter sensitivityDepth = new FloatParameter { value = 0f };

        [DisplayName("Normals sensitivity"), Range(0f, 1f), Tooltip("Sets how much difference in normals between pixels contribute to drawing an edge")]
